...
@Api(name = "offerendpoint", namespace = @ApiNamespace(ownerDomain = "ezap.com", ownerName = "ezap.com", packagePath = "miab_front"))
public class OfferEndpoint {
	...
	public CollectionResponse<Offer> listOffer(
		...
		return CollectionResponse.<Offer> builder().setItems(execute)
	...
	public void removeOffer(@Named("id") String id) {
		EntityManager mgr = getEntityManager();
		try {
			Offer offer = mgr.find(Offer.class, id);
			mgr.remove(offer);
		} finally {
			mgr.close();
		}
