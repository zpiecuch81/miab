 ...
 * on 2013-12-07 at 22:40:52 UTC 
 * Modify at your own risk.
 */

package com.ezap.miab_front.checkinendpoint;
...
public class Checkinendpoint extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  static {
    com.google.api.client.util.Preconditions.checkState(
        ...
        "1.16.0-rc of the checkinendpoint library.", com.google.api.client.googleapis.GoogleUtils.VERSION);
  }
  ...
  public class GetCheckIn extends CheckinendpointRequest<com.ezap.miab_front.checkinendpoint.model.CheckIn> {
    ...
    protected GetCheckIn(java.lang.Long id) {
      super(Checkinendpoint.this, "GET", REST_PATH, null, com.ezap.miab_front.checkinendpoint.model.CheckIn.class);
   ...
   * operation.
   *
   * @param content the {@link com.ezap.miab_front.checkinendpoint.model.CheckIn}
   * @return the request
   */
  public InsertCheckIn insertCheckIn(com.ezap.miab_front.checkinendpoint.model.CheckIn content) throws java.io.IOException {
    InsertCheckIn result = new InsertCheckIn(content);
    initialize(result);
    return result;
  }

  public class InsertCheckIn extends CheckinendpointRequest<com.ezap.miab_front.checkinendpoint.model.CheckIn> {
     ...
     * @since 1.13
     */
    protected InsertCheckIn(com.ezap.miab_front.checkinendpoint.model.CheckIn content) {
      super(Checkinendpoint.this, "POST", REST_PATH, content, com.ezap.miab_front.checkinendpoint.model.CheckIn.class);
    }
  ...
  public class ListCheckIn extends CheckinendpointRequest<com.ezap.miab_front.checkinendpoint.model.CollectionResponseCheckIn> {
    ...
    protected ListCheckIn() {
      super(Checkinendpoint.this, "GET", REST_PATH, null, com.ezap.miab_front.checkinendpoint.model.CollectionResponseCheckIn.class);
    }
   ...
   * @return the request
   */
  public UpdateCheckIn updateCheckIn(com.ezap.miab_front.checkinendpoint.model.CheckIn content) throws java.io.IOException {
    UpdateCheckIn result = new UpdateCheckIn(content);
    initialize(result);
    return result;
  }

  public class UpdateCheckIn extends CheckinendpointRequest<com.ezap.miab_front.checkinendpoint.model.CheckIn> {
     ...
     * @since 1.13
     */
    protected UpdateCheckIn(com.ezap.miab_front.checkinendpoint.model.CheckIn content) {
      super(Checkinendpoint.this, "PUT", REST_PATH, content, com.ezap.miab_front.checkinendpoint.model.CheckIn.class);
    }
