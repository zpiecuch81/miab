...
{
  /*
   * TODO: Need to change this to 'true' if you're running your backend locally
   * using the DevAppServer. See
   * http://developers.google.com/eclipse/docs/cloud_endpoints for more
   * information.
   */
  ...
  protected static final String LOCAL_APP_ENGINE_SERVER_URL =
      "http://localhost:8888/";
  /*
   * The root URL of where your DevAppServer is running when it's being accessed
   * via the Android emulator (if you're running the DevAppServer locally). In
   * this case, you're running behind Android's virtual router. See
      ...
      B builder )
  {
    if( LOCAL_ANDROID_RUN ) {
      builder
          .setRootUrl( LOCAL_APP_ENGINE_SERVER_URL_FOR_ANDROID + "/_ah/api/" );
    }
