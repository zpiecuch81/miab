...
public class Miabendpoint extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
   ...
   * @return the request
   */
  public ListMIAB listMIAB(java.lang.Long geoIndex, java.lang.Boolean isBurried) throws java.io.IOException {
    ListMIAB result = new ListMIAB(geoIndex, isBurried);
    initialize(result);
    return result;
  }
  ...
  public class ListMIAB extends MiabendpointRequest<pl.com.ezap.miab.miabendpoint.model.CollectionResponseMIAB> {
    ...
    private static final String REST_PATH = "miab/{geoIndex}/{isBurried}";
     ...
     * @since 1.13
     */
    protected ListMIAB(java.lang.Long geoIndex, java.lang.Boolean isBurried) {
      ...
      this.isBurried = com.google.api.client.util.Preconditions.checkNotNull(isBurried, "Required parameter isBurried must be specified.");
    }
    ...
    public ListMIAB setGeoIndex(java.lang.Long geoIndex) {
      this.geoIndex = geoIndex;
      return this;
    }

    @com.google.api.client.util.Key
    private java.lang.Boolean isBurried;

    /**

     */
    public java.lang.Boolean getIsBurried() {
      return isBurried;
    }

    public ListMIAB setIsBurried(java.lang.Boolean isBurried) {
