...
public class Miabendpoint extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
   ...
   * @return the request
   */
  public GetMIAB getMIAB(java.lang.String id) throws java.io.IOException {
  ...
  public class GetMIAB extends MiabendpointRequest<pl.com.ezap.miab.miabendpoint.model.MIAB> {
     ...
     * @since 1.13
     */
    protected GetMIAB(java.lang.String id) {
    ...
    public GetMIAB setId(java.lang.String id) {
      this.id = id;
      return this;
    }
   ...
   * @return the request
   */
  public RemoveMIAB removeMIAB(java.lang.String id) throws java.io.IOException {
  ...
  public class RemoveMIAB extends MiabendpointRequest<Void> {
     ...
     * @since 1.13
     */
    protected RemoveMIAB(java.lang.String id) {
    ...
    public RemoveMIAB setId(java.lang.String id) {
      this.id = id;
      return this;
    }
